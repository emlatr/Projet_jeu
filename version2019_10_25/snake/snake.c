...
void init_data_pomme(snake_t * world){ 
	...
	for(int i = 0; i<NB_POMME; i++){
		...
		world->PV[i].exist = 1;
		printf("%i, %i\n\n",world->PR[i].px, world->PR[i].py );
		printf("%i, %i\n\n",world->PV[i].px, world->PV[i].py );
...
/*void init_data_pomme_verte(snake_t * world){ 
	srand((unsigned)time(NULL));
	for(int i = 0; i<NB_POMME; i++){
		world->PV[i].Pomme = load_image( "ressources/pomme_verte.bmp" );
		world->PV[i].px = rand() % 850 + 0;
		world->PV[i].py = rand() % 550 + 0;
		printf("%i, %i\n\n",world->PV[i].px, world->PV[i].py );
	}
}*/
...
int collision_pomme_serp(snake_t* world){
	for(int i = 0; i<NB_POMME; i++){
		if(world->PR[i].exist == 1){
			if(world->PR[i].px + 4 >= world->x + 2 && world->PR[i].px + 4 <= world->x + 20 && world->PR[i].py + 1 <= world->y + 20 && world->PR[i].py + 1 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
			...
			if(world->PR[i].px + 17 >= world->x + 2 && world->PR[i].px + 17 <= world->x + 20 && world->PR[i].py + 1 <= world->y + 20 && world->PR[i].py + 1 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PR[i].exist = 0;
			...
			if(world->PR[i].px + 4 >= world->x + 12 && world->PR[i].px + 4 <= world->x + 20 && world->PR[i].py + 18 <= world->y + 20 && world->PR[i].py + 18 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PR[i].exist = 0;
			...
			if(world->PR[i].px + 17 >= world->x + 2 && world->PR[i].px + 17 <= world->x + 20 && world->PR[i].py + 18 <= world->y + 20 && world->PR[i].py + 18 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PR[i].exist = 0;
		...
		if(world->PV[i].exist == 1){
			if(world->PV[i].px + 4 >= world->x + 2 && world->PV[i].px + 4 <= world->x + 20 && world->PV[i].py + 1 <= world->y + 20 && world->PV[i].py + 1 >= world->y + 2){
				world->nb_corps += 1;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PV[i].exist = 0;
			...
			if(world->PV[i].px + 17 >= world->x + 2 && world->PV[i].px + 17 <= world->x + 20 && world->PV[i].py + 1 <= world->y + 20 && world->PV[i].py + 1 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PV[i].exist = 0;
			...
			if(world->PV[i].px + 4 >= world->x + 12 && world->PV[i].px + 4 <= world->x + 20 && world->PV[i].py + 18 <= world->y + 20 && world->PV[i].py + 18 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PV[i].exist = 0;
			...
			if(world->PV[i].px + 17 >= world->x + 2 && world->PV[i].px + 17 <= world->x + 20 && world->PV[i].py + 18 <= world->y + 20 && world->PV[i].py + 18 >= world->y + 2){
				world->nb_corps += 2;
				world->score += 1;
				printf("Votre score est de : %i", world->score);
				world->PV[i].exist = 0;
